...
Do not add `templates/`, `backend/`, or a PaaS `deploy/` zoo. Vertical apps
(RAG, video, agents, UI) are generated by
[pixeltable-skill](https://github.com/pixeltable/pixeltable-skill) into `app.py`.
